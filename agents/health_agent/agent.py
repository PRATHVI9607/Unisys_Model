...
class HealthAgent:
    ...
    def _local_assessment(
        ...
        return {
            ...
            "confidence_interval": (risk_score - 0.05, risk_score + 0.05) if risk_score > 0 else None
        }
    ...
    async def _publish_assessment(self, assessment: HealthAssessment) -> None:
        ...
        await self.redis.hset(
            ...
            mapping={
                ...
                "patch_proposal": json.dumps(assessment.patch_proposal) if assessment.patch_proposal else "",
                "explainability": json.dumps(assessment.explainability) if assessment.explainability else "",
